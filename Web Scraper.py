...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 18 13:26:03 2020
...
def get_jobs(url, num_jobs, verbose, path, slp_time):
    ...
    # '"&locT=C&locId=1147401&locKeyword=San%20Francisco,
    # %20CA&jobType=all&fromAge=-1&minSalary=0&includeNoSalaryJobs=true&radius=100&cityId=-1&minRating=0.0&industryId
    # =-1&sgocId=-1&seniorityType=all&companyId=-1&employerSizes=0&applicationType=0&remoteWorkType=0'
    driver.get(url)
    jobs = []
...
url1 = "https://www.glassdoor.com/Job/jobs.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn" \
       "&typedKeyword=" + keyword + "&sc.keyword=" + keyword + "&locT=&locId=&jobType= "
...
Data = get_jobs(url2, 1000, False, "/Users/george/Desktop/Python/Start Up2/chromedriver", 5)

Data.to_csv("/Users/george/Desktop/Python/Start Up2/JobData.csv")
